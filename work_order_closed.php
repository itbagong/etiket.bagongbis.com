<?php
// work_order_closed.php - DAFTAR WORK ORDER STATUS CLOSED
...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Work Order (Status: CLOSED)</li>
        </ol>

        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0">📋 Daftar Work Order <span class="badge <?php echo $badge_color; ?>">CLOSED</span></h3>
        ...
        <div class="card mb-3 shadow">
            <div class="card-header bg-primary text-white">
                <i class="fas fa-clipboard-list"></i> Data Work Order Status CLOSED
            </div>
            <div class="card-body">
