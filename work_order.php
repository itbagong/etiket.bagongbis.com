...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_ticket'])) {
  // saveWorkOrder akan menerima 'user_id' dari POST
...
<div class="container mt-4 mb-5">
  ...
  <form method="post">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-3">
        <label>Estimasi Biaya per Item <span class="text-danger">*</span></label> 
        <input type="number" name="cost" class="form-control" placeholder="Cth: 90000" min="0" required
