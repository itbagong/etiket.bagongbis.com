<?php
// user_header.php - VERSI DEBUG NOTIFIKASI DI DROPDOWN
...
// Pastikan path ini benar (relatif terhadap user_header.php di root)
$user = $_SESSION['user'];
require_once './src/Database.php';
require_once './src/Auth.php';
// TAMBAHAN: Include Security.php
...
<a class="navbar-brand mr-1" href="user_dashboard.php">Etiket System</a>
...
<a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Semua WO Baru & Proses">
...
<h6 class="dropdown-header">Work Order Baru & Proses</h6>
<span class="dropdown-item disabled text-center small">Memuat...</span>
</div>
</li>

<li class="nav-item dropdown no-arrow mx-1">
<a class="nav-link dropdown-toggle" href="#" id="userProgressDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="WO Anda dalam Progress">
<i class="fas fa-tasks fa-fw text-warning"></i>
<span class="badge badge-warning badge-counter d-none" id="userProgressBadge">0</span>
</a>

<div id="userProgressList" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userProgressDropdown">

    <h6 class="dropdown-header bg-warning text-white">WO Saya (Progress)</h6>
<span class="dropdown-item disabled text-center small">Memuat...</span>

    <div class="dropdown-item bg-light p-2 my-1">
        
        <div class="alert alert-info p-2 mb-1">
            DEBUG DATA: <span id="debugDataRead" class="small">Memuat data...</span>
        </div>
        
        <div class="card bg-primary text-white py-1">
            <div class="card-body p-2">
                <div class="small font-weight-bold text-white text-uppercase">
                    Total Aktif: <span id="totalActiveCount">0</span>
                </div>
...
<?php foreach ($menu_group['children'] as $child_menu): ?>
