...
$rbac_target = 'work_order_ticket.php'; 
...
<div class="container mt-4 mb-5">
    <h3 class="mb-3">🧾 Buat Work Order Baru</h3>
    ...
    <form method="post">
        ...
        <div class="mb-3">
            <label>Deskripsi Masalah Umum</label>
        ...
        <div class="mb-3">
            <label>Alasan Pengajuan / Detail Masalah Item</label>
            <input type="text" name="reason" class="form-control" placeholder="Cth: Printer macet, Laptop blue screen" required
